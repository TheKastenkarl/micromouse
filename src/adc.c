...
void setupADC1()
{
    ...
    AD1CON3bits.SAMC = 0x05; // auto sample time bits, number of Tad (franz: Tad = period of ADC, total sample time of one channel: SAMC * Tad, total sample time of n channels: n * SAMC * Tad)
    ...
    IFS0bits.AD1IF = 0; // reset ADC1 interrupt flag
    IEC0bits.AD1IE = 0; // disable ADC1 interrupt
